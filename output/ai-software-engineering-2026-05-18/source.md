---
description: AI 时代软件工程从执行能力转向系统责任的博客草稿与个人定位整理
last_updated: 2026-05-18
---

# AI 时代的软件工程：从执行能力到系统责任

副标题：如果 AI 已经能写很多代码，程序员更应该加强什么？
...
这篇文章承接之前的《[AI 写代码很强，又微妙地不行](https://lin-guanguo.github.io/Lin-Guanguo/read/202603/ai-technical-debt/)》。上一篇主要讨论 AI 写代码的能力边界：AI 很强，但在大型项目、长期维护和技术债治理上，仍然微妙地不行。

这篇不再重复分析 AI 不擅长什么，而是换一个问题：如果 AI 已经能写越来越多代码，程序员应该把能力往哪里迁移？

文章的目的不是泛泛讨论“程序员会不会失业”，而是借这个问题梳理自己的职业定位：从数据平台工程，到生产级 Agent 系统，底层能力都是构建稳定复杂系统。
